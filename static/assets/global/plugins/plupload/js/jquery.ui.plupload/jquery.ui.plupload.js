...
@param {Object} settings For detailed information about each option check documentation.
	...
	@param {Object} [settings.filters={}] Set of file type filters.
		...
		@param {String|Number} [settings.filters.max_file_size=0] Maximum file size that the account can pick, in bytes. Optionally supports b, kb, mb, gb, tb suffixes. `e.g. "10mb" or "1gb"`. By default - not set. Dispatches `plupload.FILE_SIZE_ERROR`.
	...
	@param {Number|String} [settings.max_file_size] Maximum file size that the account can pick, in bytes. Optionally supports b, kb, mb, gb, tb suffixes. `e.g. "10mb" or "1gb"`. By default - not set. Dispatches `plupload.FILE_SIZE_ERROR`.
